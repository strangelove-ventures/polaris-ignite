...
export function createBaseEvidence(): Evidence {
...
export function createBaseDuplicateVoteEvidence(): DuplicateVoteEvidence {
...
export function createBaseLightClientAttackEvidence(): LightClientAttackEvidence {
  return {
...
export function createBaseEvidenceList(): EvidenceList {
  return { evidence: [] };
}
