...
export function createBasePlan(): Plan {
...
export function createBaseSoftwareUpgradeProposal(): SoftwareUpgradeProposal {
...
export function createBaseCancelSoftwareUpgradeProposal(): CancelSoftwareUpgradeProposal {
...
export function createBaseModuleVersion(): ModuleVersion {
