...
export function createBaseQueryGrantsRequest(): QueryGrantsRequest {
...
export function createBaseQueryGrantsResponse(): QueryGrantsResponse {
...
export function createBaseQueryGranterGrantsRequest(): QueryGranterGrantsRequest {
...
export function createBaseQueryGranterGrantsResponse(): QueryGranterGrantsResponse {
  return { grants: [], pagination: undefined };
}
...
export function createBaseQueryGranteeGrantsRequest(): QueryGranteeGrantsRequest {
...
export function createBaseQueryGranteeGrantsResponse(): QueryGranteeGrantsResponse {
  return { grants: [], pagination: undefined };
}
