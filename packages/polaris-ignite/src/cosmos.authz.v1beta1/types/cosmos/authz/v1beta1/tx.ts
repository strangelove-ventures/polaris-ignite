...
export function createBaseMsgGrant(): MsgGrant {
...
export function createBaseMsgGrantResponse(): MsgGrantResponse {
  return {};
}
...
export function createBaseMsgRevoke(): MsgRevoke {
...
export function createBaseMsgRevokeResponse(): MsgRevokeResponse {
  return {};
}
